...
- [x] **Suite de tests en 277** (+48 sobre 229: gpu_specs, estimation_models, model_parallel, precision/Tensor-cores, i18n, dashboard modular). Todo integrado en `develop` y subido a GitHub.
