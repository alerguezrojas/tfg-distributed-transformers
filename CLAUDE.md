...
- [x] **Suite de tests en 261** (+32 sobre 229: gpu_specs, estimation_models, model_parallel equivalencia/gradiente, parser `#gpu`, dashboard modular). Todo integrado en `develop` y subido a GitHub.
