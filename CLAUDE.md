...
- [x] **Suite de tests en 271** (+42 sobre 229: gpu_specs, estimation_models, model_parallel, precision/Tensor-cores + parser `#precision`, dashboard modular). Todo integrado en `develop` y subido a GitHub.
