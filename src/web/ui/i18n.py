...
TRANSLATIONS: dict[str, str] = {
    ...
    "Single vs Distributed — measured speedup": "Single vs Distribuido — speedup medido",
    "Predicted speedup (feasibility)": "Speedup predicho (viabilidad)",
    "Measured speedup": "Speedup medido", "Prediction error": "Error de predicción",
    ...
    "Cloud cost": "Coste en la nube",
    "Cloud training cost (estimated)": "Coste de entrenamiento en la nube (estimado)",
    "Download cost table": "Descargar tabla de costes",
